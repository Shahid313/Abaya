    ...
    const goToOrderCompleted = () => {
        ...
        <Text style={{color:'black',fontSize:30,textAlign:'center',fontWeight:'bold',marginTop:20,fontFamily:'Sen'}}>REVIEW</Text>
            ...
            <View style={{backgroundColor:'#EEEEEE',width:Dimensions.get('window').width*2/2.3,padding:10,alignSelf:'center',marginTop:15}}>
                ...
                <TouchableOpacity onPress={() => goToOrderCompleted()} style={{borderColor:'black',alignSelf:'center',alignItems: 'center',backgroundColor:'black',justifyContent: 'center',borderWidth:1,borderRadius:30,width:Dimensions.get('window').width*2/3.5,marginBottom:30,marginTop:40}}>
